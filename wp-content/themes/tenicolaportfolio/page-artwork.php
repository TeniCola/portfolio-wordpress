<?php
/**
 * The template for displaying the "Artwork" page
 * // NEAR IDENTICAL TO OTHER GALLERY PAGES and serves as a temporary combo of the Illustrations & Comics page //
 * 
 *
 * @package WordPress
...
get_header(); ?>
	...
	<div id="primary">
		<div class="frame-width main-content" role="main">
			...
			<div>
				<?php query_posts('post_type=artwork&order=ASC'); ?>
				<?php while ( have_posts() ) : the_post();
				$size = 'medium';
				$full = 'full';
				// IMAGES
